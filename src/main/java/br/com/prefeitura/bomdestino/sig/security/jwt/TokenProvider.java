package br.com.prefeitura.bomdestino.sig.security.jwt;
...
public class TokenProvider implements InitializingBean {
    ...
    public void validateOrigin(String authToken) {
        Claims claims = resolveClaims(authToken);
        User user = genericUserRepository.findById(Long.valueOf(claims.get(UID_KEY).toString())).orElse(null);
        if (Objects.isNull(user) || Boolean.FALSE.equals(user.isActivated()) || user.getBlinding()) {
