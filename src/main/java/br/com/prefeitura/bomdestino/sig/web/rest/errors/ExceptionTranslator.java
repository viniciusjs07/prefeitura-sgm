...
import br.com.prefeitura.bomdestino.sig.service.InvalidPasswordException;
import br.com.prefeitura.bomdestino.sig.service.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(EmailAlreadyUsedException ex, NativeWebRequest request) {
        BadRequestAlertException problem = AlertException.emailAlreadyUsedException();
    ...
    public ResponseEntity<Problem> handleUsernameAlreadyUsedException(UsernameAlreadyUsedException ex, NativeWebRequest request) {
        BadRequestAlertException problem = AlertException.loginAlreadyUsedException();
        return create(problem, request);
    }

    @ExceptionHandler
    public ResponseEntity<Problem> handleInvalidPasswordException(InvalidPasswordException ex, NativeWebRequest request) {
        AlertException problem = AlertException.invalidPasswordException();
        return create(problem, request);
    }
